...
class TOOLS_PT_Archipack_Create(Panel):
    ...
    def draw(self, context):
        ...
        box = row.box()
        box.label("Room Objects")
        
        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.wall2",text="Add Wall",icon_value=icons["wall"].icon_id)
        
        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.window_preset_menu",text="Place Window",icon_value=icons["window"].icon_id).preset_operator = "archipack.window_draw"
                    
        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.door_preset_menu",text="Place Door",icon_value=icons["door"].icon_id).preset_operator = "archipack.door_draw"
        
        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.stair_preset_menu",text="Place Stair",icon_value=icons["stair"].icon_id).preset_operator = "archipack.stair"

        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.fence_preset_menu",text="Fence",icon_value=icons["fence"].icon_id).preset_operator = "archipack.fence"
        row.operator("archipack.fence_from_curve", text="From Curve", icon='CURVE_DATA')
        
        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.truss",icon_value=icons["truss"].icon_id)
        
      
        
#         row = box.row(align=True)
#         row.operator("archipack.slab_from_curve",icon_value=icons["slab"].icon_id)
        
#         row = box.row(align=True)
#         row.operator("archipack.wall2_from_slab",icon_value=icons["wall"].icon_id)
#         row.operator("archipack.slab_from_wall",icon_value=icons["slab"].icon_id).ceiling = False
#         row.operator("archipack.slab_from_wall",text="->Ceiling",icon_value=icons["slab"].icon_id).ceiling = True
        
        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.roof_preset_menu",text="Roof",icon_value=icons["roof"].icon_id).preset_operator = "archipack.roof"
        
        row = box.row(align=True)
        row.scale_y = 1.3
        row.operator("archipack.floor_preset_menu",text="Floor",icon_value=icons["floor"].icon_id).preset_operator = "archipack.floor"
